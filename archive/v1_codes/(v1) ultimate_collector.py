...
# Forçar carregamento do token correto antes de importar o coletor
apiafrica_path = project_root / "apiafrica.txt"
if apiafrica_path.exists():
    api_key = apiafrica_path.read_text(encoding="utf-8").strip()
    if api_key:
        os.environ["API_KEY"] = api_key
        os.environ.setdefault("AUTH_TYPE", "x-api-key")

# Garantir que o config_unificado.env também seja considerado
try:
