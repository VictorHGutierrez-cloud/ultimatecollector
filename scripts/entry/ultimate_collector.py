...
class UltimateCollectorMenu:
    ...
    def _build_menu_actions(self):
        ...
        categories = self.collector.list_categories()
    ...
    def collect_category_by_name(self, category: str):
        ...
        print("-" * 50)
        success = self.collector.collect_category(category)
        if success:
    ...
    def collect_employees(self):
        ...
        print("-" * 50)
        success = self.collector.collect_employees()
        if success:
    ...
    def collect_expenses(self):
        ...
        print("\n💰 COLETANDO DESPESAS...")
        print("-" * 50)
        success = self.collector.collect_expenses()
        if success:
    ...
    def collect_finance(self):
        ...
        print("-" * 50)
        success = self.collector.collect_finance()
        if success:
    ...
    def collect_attendance(self):
        ...
        print("\n⏰ COLETANDO PRESENÇA...")
        print("-" * 50)
        success = self.collector.collect_attendance()
        if success:
    ...
    def collect_time_off(self):
        ...
        print("-" * 50)
        success = self.collector.collect_time_off()
        if success:
    ...
    def collect_recruitment(self):
        ...
        print("-" * 50)
        success = self.collector.collect_recruitment()
        if success:
    ...
    def collect_performance(self):
        ...
        print("-" * 50)
        success = self.collector.collect_performance()
        if success:
    ...
    def collect_training(self):
        ...
        print("-" * 50)
        success = self.collector.collect_training()
        if success:
    ...
    def collect_documents(self):
        ...
        print("-" * 50)
        success = self.collector.collect_documents()
        if success:
    ...
    def collect_company(self):
        ...
        print("-" * 50)
        success = self.collector.collect_company()
        if success:
    ...
    def analyze_data(self):
        ...
        try:
            ...
            if 0 <= choice < len(categories):
                ...
                analysis = self.collector.analyze_data(category)
                print(f"\n📊 Análise de {category}:")
        ...
        try:
            ...
            if 0 <= choice < len(categories):
                ...
                if format_choice in ['excel', 'csv']:
                    success = self.collector.export_data(category, format_choice)
                    if success:
    ...
    def validate_data(self):
        ...
        try:
            ...
            if 0 <= choice < len(categories):
                category = categories[choice]
                validation = self.collector.validate_data(category)
    ...
    def backup_data(self):
        ...
        try:
            ...
            if 0 <= choice < len(categories):
                category = categories[choice]
                success = self.collector.backup_data(category)
                if success:
    ...
    def cleanup_data(self):
        ...
        try:
            ...
            if 0 <= choice < len(categories):
                ...
                success = self.collector.cleanup_old_data(category, days)
                if success:
    ...
    def list_categories(self):
        ...
        for i, category in enumerate(categories, 1):
            endpoints = self.collector.list_endpoints(category)
    ...
    def check_status(self):
        ...
        print("\n📊 STATUS DO SISTEMA")
        print("-" * 50)
        status = self.collector.check_status()
    ...
    def configure_filters(self):
        ...
        try:
            ...
            if 0 <= choice < len(categories):
                ...
                success = self.collector.configure_filters(category, filters)
                if success:
    ...
    def monitor_collection(self):
        ...
        try:
            ...
            if 0 <= choice < len(categories):
                category = categories[choice]
                monitor = self.collector.monitor_collection(category)
    ...
    def collect_with_date_filter(self):
        ...
        try:
            ...
            if 0 <= choice < len(categories):
                ...
                success = self.collector.collect_category(category, days)
                if success:
