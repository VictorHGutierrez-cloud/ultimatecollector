...
# -*- coding: utf-8 -*-
"""
Script CORRIGIDO para gerar turnos de agosto para todos os funcionários ativos
"""
...
def gerar_turnos_agosto():
    ...
    print("🗓️  GERADOR DE TURNOS - AGOSTO 2024 (CORRIGIDO)")
    print("=" * 60)
...
def testar_turno_unico():
    ...
    try:
        # Testar com Samuel Santos (ID: 270284)
        clock_in = datetime(2024, 8, 15, 8, 0, 0, tzinfo=timezone.utc)
        clock_out = datetime(2024, 8, 15, 17, 0, 0, tzinfo=timezone.utc)
